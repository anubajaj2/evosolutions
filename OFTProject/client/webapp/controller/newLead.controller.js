		...
		onPressSendEmail: function(oEvent){
			...
			for(var item of selectedItems){
				...
				for(var courseId of item.CourseName){
					...
					debugger;
					payload.EmailTemplate = payload.EmailTemplate.replace("Parent",payload.FatherName);
					payload.EmailTemplate = payload.EmailTemplate.replace("Ward Name",payload.WardName);
